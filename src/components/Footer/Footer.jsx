        ...
        <div className='bg-black text-white rounded-t-3xl mt-8 md:mt-0'>
            <div className='flex flex-col md:flex-row justify-between p-8 md:px-32 px-5'>
                <div className='w-full md:w-1/4'>
                    ...
                    <p className='text-sm'>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium, error.</p>
                </div>
                <div >
                    <h1 className='font-medium text-xl pb-4 pt-5 md:pt-0'>Links</h1>
                    <nav className='flex flex-col gap-2'>
                        <a className='hover:text-brightColor transition-all cursor-pointer' href="/">Home</a>
                        <a className='hover:text-brightColor transition-all cursor-pointer' href="/">popular</a>
                ...
                <div >
                    ...
                    <nav className='flex flex-col gap-2'>
                        <a className='hover:text-brightColor transition-all cursor-pointer' href="/">FoodiePoodie@email.com</a>
                        <a className='hover:text-brightColor transition-all cursor-pointer' href="/"> +64 123 456 789</a>
